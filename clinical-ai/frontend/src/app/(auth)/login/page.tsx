...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    if (!clinicalId || !passcode) { setError("Please fill in all fields."); return; }
    setError("");
    setLoading(true);
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
              <label style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" as const, color: "#374151" }}>Passcode</label>
          ...
          >
            {loading ? (
              ...
              <><span>Initialize Session</span><ArrowRight size={16} /></>
            )}
          </motion.button>
        </div>
      </motion.div>
